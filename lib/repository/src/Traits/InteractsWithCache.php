 ...
 * @package Fabrikod\Repository\Traits
...
trait InteractsWithCache
{
    ...
    public function getRepository()
    {
        if (is_null($this->cacheRepository)) {
            $this->cacheRepository = resolve(config('repository.cache.repository', 'cache'));
        }
     ...
     *
     * @param  \Fabrikod\Repository\Contracts\Filter $criterion
     * @return \Fabrikod\Repository\Contracts\Filter|array
     *
     * @throws \Exception
     */
    ...
    public function all($columns = ['*'])
    {
        ...
        $value = $this->getRepository()->remember($key, $minutes, function () use ($columns) {
            return parent::all($columns);
        });
    ...
    public function paginate($limit = null, $columns = ['*'], $method = 'paginate')
    {
        ...
        $minutes = $this->getCacheMinutes();
        $value = $this->getRepository()->remember($key, $minutes, function () use ($limit, $columns, $method) {
            return parent::paginate($limit, $columns, $method);
        });
    ...
    public function find($id, $columns = ['*'])
    {
        ...
        $minutes = $this->getCacheMinutes();
        $value = $this->getRepository()->remember($key, $minutes, function () use ($id, $columns) {
            return parent::find($id, $columns);
        });
    ...
    public function findByField($field, $value = null, $columns = ['*'])
    {
        ...
        $minutes = $this->getCacheMinutes();
        $value = $this->getRepository()->remember($key, $minutes, function () use ($field, $value, $columns) {
            return parent::findByField($field, $value, $columns);
        });
    ...
    public function findWhere(array $where, $columns = ['*'])
    {
        ...
        $minutes = $this->getCacheMinutes();
        $value = $this->getRepository()->remember($key, $minutes, function () use ($where, $columns) {
            return parent::findWhere($where, $columns);
        });
     ...
     * @return mixed
     */
    public function getByCriteria(Filter $criteria)
    {
        ...
        $minutes = $this->getCacheMinutes();
        $value = $this->getRepository()->remember($key, $minutes, function () use ($criteria) {
            return parent::getByCriteria($criteria);
        });
