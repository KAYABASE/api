...
return [
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | This middleware will be assigned to every api request
    | and it will be apply the locale from given header name.
    */

    'middleware' => Fabrikod\ApiLocalization\Middleware\ApiLocalizationMiddleware::class,

    /*
    |--------------------------------------------------------------------------
    | Enable Middleware Exception
    |--------------------------------------------------------------------------
    |
    | If you want to enable the middleware exception, you can do so by
    | enabling this option. This middleware will throw an exception if
    | the request locale is not supported by the application.
    */

    'enable_middleware_exception' => false,
    ...
    |--------------------------------------------------------------------------
    |
    | The header name to be used to determine the locale.
    */
    ...
    | you can use the mapping to tallow the LanguageNegotiator to assign the descired
    | locales based on HTTP Header.
    |
    | For example you want ot use 'at', so map HTTP Header 'de-AT' to 'at'.
    | @example: ['de-AT' => 'at'].
    */
    ...
    | Defaults to most common ".UTF-8". Set to blank on Windows systems,
    | change to ".utf8" on CentOS and similar.
    */

    'utf8suffix' => env('UTF8_SUFFIX', '.UTF-8'),
    ...
    |--------------------------------------------------------------------------
    |
    | If you want to ignore some urls, you can specify them in the array.
    |
    | @example: ['api/settings/*', 'api/users/*']
    */
